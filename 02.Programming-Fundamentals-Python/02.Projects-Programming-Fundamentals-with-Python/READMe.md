# 🚀 Beginner-Level Python Projects – SoftUni (Additional Practice)

This section of the repository contains additional Python projects created as part of the core programming curriculum. Each project demonstrates the application of fundamental concepts through simple and functional console-based applications.
